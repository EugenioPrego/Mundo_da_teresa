            ...
            <div class="col6-mx-auto col3-mx-auto col-mx-auto">
                  <div class="fixar">
                    ...
                    <div class="formulario">
                            <div class="col6-mx-auto col3-mx-auto col-mx-auto">
                            <form action="./php/visao/Login/cadastrar.php" method="post">
                              <div class="criar">
                               <a href="./index.html"><i id="icone-voltar" class="bi bi-arrow-left-short"></i></a> 
                                <h2>Criar Conta</h2>
                              </div>
                              <div class="sub-formulario">
                                <label  for="nome">👤 Nome Completo:</label>
                                <input  type="text" placeholder=" digite seu nome completo" name="nome" id="nome" required >
                                <label for="dataNascimento">📅 Data de Nascimento:</label>
                                <input type="date" name="  dataNascimento" id="dataNascimento" required>
                                <label for="telefone">📞Telefone:</label>
                                <input type="number" placeholder="  digite seu número de telefone" name="telefone" id="telefone" required>
                                ...
                                <button type="submit" name="btn-entrar">Criar Conta</button>
                                <div style="padding-bottom: 50px;" class="criar-conta">Já tem uma conta? <a style="color: blue;" href="entrar.php">entrar</a></div>
                              </div>
